...
if (isset($_POST["phpmailer"])) {
    ...
    $mail->Username = "marcotally95@gmail.com";
    $mail->Password = "marco290395tally";

    $mail->From = "marcotally95@gmail.com";
    ...
    if ($mail->Send()) {
?>
                <script>alert("Mensaje enviado a <?php echo $email; ?> !!");</script>
        <?php
    } else {
        ?>
                <script>alert("Error <?php echo $email; ?> !!");</script>
        <?php
    }
}
